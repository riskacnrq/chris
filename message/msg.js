...
const chrisapi = "yonzcyy Bot"

// SETTING BOT AND OWNER //
const nobot = "6281215083992" // Ganti No Bot Kalian
const namabot = "yonzcyy MD" // Ganti Nama Bot Kalian
const nameown = "liaa" // Ganti Nama Kalian
const numown = "0882-2760-6701" // Ganti Nomor Kalian
const nameowner = "lia" // Ganti Nama Kalian
const footer = "yonzcyy MD 2022" // Ganti Nama Bot Kalian
const capt = "*yonzcyy Bot MD*" // Ganti Nama Bot Kalian
const nomorown = "https://wa.me/6288227606701" // Ganti Nomor Kalian
const note = "*Bot Ini Dalam Pengembangan*\n*Jika Ada Fitur Yang Eror Segera Hub Owner*" // Kalau Mau Ganti Aja
const namagrup = "Group bot" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "0882-2760-6701" // Ganti Nomor Gopay Mu
const pulsa = "0882-2760-6701" // Ganti No Pulsa Mu
const insta = "lia.cans" // Ganti Nama IG Mu
const github = "donaya365" // Ganti Nama Github Mu
...
const nomor = "wa.me/6288227606701"
...
module.exports = async(conn, msg, m, setting, store, _afk) => {
    ...
    const readmore = more.repeat(4001)
		...
		const isOwner = ownerNumber == sender ? true : [`${ownerNumber}@s.whatsapp.net`, "6288227606701@s.whatsapp.net"].includes(sender) ? true : false
        ...
        const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "120363040646100247@g.us","inviteCode": "https://chat.whatsapp.com/LsNzi7PDERyB9xIlW0F8Eq","groupName": "yonzcyy  Bot", "caption": `� ${pushname}`, 'jpegThumbnail': fs.readFileSync(setting.pathimg)}}}
    ...
    const fake = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `120363040646100247@g.us` } : {}) },message: { "imageMessage": { "title":`yonzcyy  BOT MULTI DEVICE\n${ucapanWaktu} ${pushname !== undefined ? pushname : `Kak`}`, "h": `Hmm`,'seconds': '100000000', 'caption': `yonzcyy  MULTI DEVICE\n${ucapanWaktu} ${pushname !== undefined ? pushname : `Kak`}`, 'jpegThumbnail': fs.readFileSync(setting.pathimg)}}}
...
if (chats.startsWith(`@6288227606701`)){ 
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `Group yonzcyy  Bot`, url : `${setting.grup}` } },
...
- Rp. 8.000 - 1 Tahun`
			    ...
			    break
//Store Menu By yonzcyy-md
case prefix+'listff': //By yonzcyy-md
...
*Jika Ingin Order Klick Button Dibawah Atau Ketik ${prefix}formatid*`
			    ...
			    break
case prefix+'rekber': //By yonzcyy-md
...
 ${rekberh}`
			    ...
			    break
case prefix+'formatid': // By yonzcyy-md
  fakemsg(`*[ FORMAT FF ]*\n\nID Game = \nNick Game = \nJumlah Diamond = \nPembayaran Via = \n\n*Kirim Formulir Ini Ke ${nomor}*`)
  break
case prefix+'sv&&gc': //By yonzcyy-md
...
_Sc Versi 2 Berpassword Syarat : Subscribe https://youtube.com/channel/UCbetUssizXWLgZdDVEFp8Sg Dan Screenshot Kirim Ke Owner_`
			    ...
			    break
case prefix+'rules': //By yonzcyy-md
...
😖🙏`
			    ...
			    break
case prefix+'sewabot': //By yonzcyy-md
  var teks = `*── 「 SEWA BOT 」 ──*
...
break
case prefix+'thanhshshsksto':
case prefix+'tqbsbsbhshsto':
...
case prefix+'ban':
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				fakemsg(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using yonzcyy -Bot!`, video: {url: data.nowm}, templateButtons: tidtod, footer: `Tiktok Downloader`, mentions: [sender]} )
			}).catch(() => reply(mess.error.api))
			limitAdd(sender, limit)
			    break
...
limitAdd(sender, limit)
					break
case prefix+'cekbapak': // By yonzcyy-md
...
Note : Anggap "<" dan ">" Tidak Ada
 ...
 break
//Wallpaper
case prefix+'cosplay': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'hinata': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'minato': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'boruto': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'yotsuba': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'waifu2': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'shinomiya': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'yumeko': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'shizuka': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'mikasa': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'elaina': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'deidara': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'itachi': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'sakura': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'madara': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'tsunade': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'onepiece': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
break
case prefix+'megumin': // By yonzcyy-md
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
fakemsg(mess.wait)
...
conn.sendMessage(from, {caption: `Sange kok sama gambar`, image: {url: hasil}}, {quoted: fake})
break 
///MAKER MENU BY JOJO AND yonzcyy-md!!!
case prefix+'glitch':
...
limitAdd(sender, limit)
break
case prefix+'goldenroses': // By yonzcyy-md
  if (args.length < 2) return reply(`Kirim perintah ${command} <Text1>`)
  if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
  reply("Tunggu Sebentar Sedang Membuat Makernya Sekitar 1 Menit Kurang")
...
limitAdd(sender, limit)
break
case prefix+'thunder': // By yonzcyy-md
...
break
case prefix+'neonlight': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'neondevil': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'hallowen': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'skytext': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'holografic': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'grafity': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'christmas': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'luxury': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'harrypotter': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'brokenglass': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'artpapper': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'watercolor': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'glossymaker': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'multicolor': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'deluxesilver': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'gluetext': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'fabric': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'engraved': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'writing': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'wicker': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'larva': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'toxic': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'koipish': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'strobery': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'jokerlogo': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *${nameown}`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'ninjalogo': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *text1 | text2*`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'vintage': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *text1 | text2*`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
var text1 = q.split('|')[0] ? q.split('|')[0] : q
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'lionlogo': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *text1 | text2*`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
var text1 = q.split('|')[0] ? q.split('|')[0] : q
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'avengers': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *text1 | text2*`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
var text1 = q.split('|')[0] ? q.split('|')[0] : q
...
conn.sendMessage(from, {caption: `${capt}`, image: {url: data.result}}, {quoted: fake})
break
case prefix+'pornhub': // By yonzcyy-md
if (args.length < 2) return reply(`Kirim perintah ${command} *text1 | text2*`)
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
var text1 = q.split('|')[0] ? q.split('|')[0] : q
